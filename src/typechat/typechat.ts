...
export interface TypeChatJsonTranslator<T extends object> {
     ...
     */
    createRequestPrompt(request: string, guildlines?: string): string;
    /**
     ...
     */
    translate(request: string, guidelines?: string): Promise<Result<T>>;
}
...
export function createJsonTranslator<T extends object>(model: TypeChatLanguageModel, schema: string, typeName: string): TypeChatJsonTranslator<T> {
    ...
    function createRequestPrompt(request: string, guidelines?: string) {
    ...
    async function translate(request: string, guidelines?: string) {
        let prompt = typeChat.createRequestPrompt(request, guidelines);
